...
# Plot the graph
plt.plot(timestamps, num_vehicles_within_reduced_range, marker='o')
plt.xlabel('Time')
plt.ylabel('Number of Vehicles within Reduced TR of Node X')
#plt.title(f'Number of Vehicles within Reduced Transmission Range of {vehicle_id}')
plt.grid(True)
plt.show()
